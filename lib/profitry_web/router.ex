defmodule ProfitryWeb.Router do
  ...
  scope "/", ProfitryWeb do
    ...
    live "/portfolios/:portf_id", PositionLive.Index, :list
    live "/portfolios/:portf_id/positions/new", PositionLive.Index, :new
    live "/portfolios/:portf_id/positions/:id/edit", PositionLive.Index, :edit

    live "/portfolios/:portf_id/positions/:pos_id/orders", OrderLive.Index, :list
    live "/portfolios/:portf_id/positions/:pos_id/orders/new", OrderLive.Index, :new
    live "/portfolios/:portf_id/positions/:pos_id/orders/:id/edit", OrderLive.Index, :edit
  end
