defmodule ProfitryAppWeb.UserAuthTest do
  use ProfitryAppWeb.ConnCase, async: true

  alias Phoenix.LiveView
  alias ProfitryApp.Accounts
  alias ProfitryAppWeb.UserAuth
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, ProfitryAppWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      ProfitryAppWeb.Endpoint.subscribe(live_socket_id)
