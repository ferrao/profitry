defmodule ProfitryAppWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(ProfitryAppWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(ProfitryAppWeb.Gettext, "errors", msg, opts)
    # end
